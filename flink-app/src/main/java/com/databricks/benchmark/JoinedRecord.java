...
public class JoinedRecord {
  ...
  public JoinedRecord(long time, byte[] payload, long lookupValue) {
    this.time = time;
  ...
  public boolean equals(Object o) {
    ...
    JoinedRecord that = (JoinedRecord) o;
    return time == that.time
        && lookupValue == that.lookupValue
        && java.util.Arrays.equals(payload, that.payload);
  }

  @Override
  public int hashCode() {
    int result = java.util.Objects.hash(time, lookupValue);
