...
public class TimeAndPayloadWithKey {
  public long time;
  public byte[] payload;
  public long joinKey;

  public TimeAndPayloadWithKey() {}

  public TimeAndPayloadWithKey(long time, byte[] payload, long joinKey) {
    this.time = time;
  ...
  public boolean equals(Object o) {
    ...
    TimeAndPayloadWithKey that = (TimeAndPayloadWithKey) o;
    return time == that.time
        && joinKey == that.joinKey
        && java.util.Arrays.equals(payload, that.payload);
  }

  @Override
  public int hashCode() {
    int result = java.util.Objects.hash(time, joinKey);
